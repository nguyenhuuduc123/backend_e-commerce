...
const userCart = asyncHandler(async (req,res)=> {
    ...
    try {
        ...
        const allreadyExist = await Cart.findOne({orderby : user._id});
        if(allreadyExist){
            allreadyExist.remove();
        }
...
const applyCoupon = asyncHandler(async (req,res)=> {
    ...
    let totalAffterDiscount = (cartTotal - (cartTotal * validCoupon.discount)/100).toFixed(2);
    await Cart.findOneAndUpdate({orderby : user._id},{totalAffterDiscount},{new : true});
